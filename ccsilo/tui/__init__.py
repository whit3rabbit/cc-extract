...
__all__ = [
    ...
    "_cycle_variant_ccrouter_config", "_cycle_variant_ccrouter_mode", "_toggle_variant_ccrouter_autostart",
...
from .variant_actions import (
    ...
    toggle_variant_ccrouter_autostart as _toggle_variant_ccrouter_autostart,
    toggle_variant_model_proxy as _toggle_variant_model_proxy,
    ...
    variant_ccrouter_options_for_create as _variant_ccrouter_options_for_create,
    variant_credential_env_for_create as _variant_credential_env_for_create,
    variant_model_proxy_options_for_create as _variant_model_proxy_options_for_create,
...
def run_tui():
    ...
    def render(term, app_state):
        ...
        try:
            ...
            screen.set_block_title("ccsilo", True)
